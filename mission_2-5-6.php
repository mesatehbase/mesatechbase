<html>
<head>
<title>form2-5-6</title>
<meta charset="UTF-8 ">
</head>
</html>
<?php
$filename='mission_2-5-6.txt';
...
if(file_exists($filename)){
	$hairetu=file("mission_2-5-6.txt");
...
if($new_line[0]==$editform){
	$f=fopen($filename, "a");
	$newdata=$editform."<>".$_POST['name']."<>".$_POST['comment']."<>".date("Y/m/d H:i:s")."<>".$_POST['password']."<>"."\n";
	fwrite($f,$newdata);
	fclose($f);
...
?>
<form action="mission_2-5-6.php"method="post">
